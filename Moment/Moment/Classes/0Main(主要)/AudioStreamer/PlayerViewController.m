...
<<<<<<< HEAD:01-片刻/01-片刻/Classes/0Main(主要)/AudioStreamer/PlayerViewController.m
    CGFloat pageContorlY = self.scrollView.frame.size.height - 80;
=======
    CGFloat pageContorlY = self.scrollView.frame.size.height - PKPlayViewHeight-20;
>>>>>>> DeveloperBranch:Moment/Moment/Classes/0Main(主要)/AudioStreamer/PlayerViewController.m
...
=======
    ...
    PlayPauseView.backgroundColor = [UIColor whiteColor];
    [self.view addSubview:PlayPauseView];
    
    _buttonStop = [UIButton buttonWithType:UIButtonTypeSystem];
//    [_buttonStop setTitle:@"Stop" forState:UIControlStateNormal];
    [_buttonStop setImage:[[UIImage imageNamed:@"stop"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
    [_buttonStop addTarget:self action:@selector(_actionStop:) forControlEvents:UIControlEventTouchDown];
    [PlayPauseView addSubview:_buttonStop];
    
    _buttonPlayPause = [UIButton buttonWithType:UIButtonTypeSystem];
//    [_buttonPlayPause setTitle:@"Play" forState:UIControlStateNormal];
    [_buttonPlayPause setImage:[[UIImage imageNamed:@"play"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]forState:UIControlStateNormal];
    [_buttonPlayPause addTarget:self action:@selector(_actionPlayPause:) forControlEvents:UIControlEventTouchDown];
    [PlayPauseView addSubview:_buttonPlayPause];
    
    _buttonNext = [UIButton buttonWithType:UIButtonTypeSystem];
//    [_buttonNext setTitle:@"Next" forState:UIControlStateNormal];
    [_buttonNext setImage:[[UIImage imageNamed:@"nextMusic"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
    [_buttonNext addTarget:self action:@selector(_actionNext:) forControlEvents:UIControlEventTouchDown];
...
//    [_buttonPlayPause setTitle:@"Pause" forState:UIControlStateNormal];
          [_buttonPlayPause setImage:[[UIImage imageNamed:@"pause"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
