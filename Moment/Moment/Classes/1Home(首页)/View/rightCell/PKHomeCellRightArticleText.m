...
@interface PKHomeCellRightArticleText ()
...
@implementation PKHomeCellRightArticleText

+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"PKHomeCellRightArticleText";
    PKHomeCellRightArticleText *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        
        cell = [[[NSBundle mainBundle]loadNibNamed:@"PKHomeCellRightArticleText" owner:nil options:nil] lastObject];
