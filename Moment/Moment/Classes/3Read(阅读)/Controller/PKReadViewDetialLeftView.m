...
@interface PKReadViewDetialLeftView ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation PKReadViewDetialLeftView
- (void)dealloc
{
    self.statuses = nil;
    self.tableView = nil;
...
<<<<<<< HEAD:01-片刻/01-片刻/Classes/3Read(阅读)/Controller/PKReadViewDetialController.m
    // 2,上拉刷新(上拉加载更多数据)
    [self.tableView addLegendFooterWithRefreshingTarget:self refreshingAction:@selector(loadMoreData)];
=======
>>>>>>> DeveloperBranch:Moment/Moment/Classes/3Read(阅读)/Controller/PKReadViewDetialLeftView.m
}
