...
-(void)setupWebView
{
    ...
    // 1,加载刷新titleView
    [self.commintBtn setTitle:[NSString stringWithFormat:@"%@",self.webViewModel.counterList.comment.stringValue] forState:UIControlStateNormal];
    [self.likeBtn setTitle:[NSString stringWithFormat:@"%@",self.webViewModel.counterList.like.stringValue] forState:UIControlStateNormal];
